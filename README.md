...
the middleware will catch `actionToCatch`; note: when the middleware intercept a matching action, it will return this promise called so you can await on it (pretty useful on SSR)
